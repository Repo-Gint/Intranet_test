  ...
  <div class="col-lg-12">
    <div class="card bg-seccion shadow">
      <div class="card-header p-0">
        <img src="{{ asset("img/material_corporativo.jpg") }}" class="img-fluid m-0 p-0 rounded-top" style="width: 100%; height: 100px;">
      </div>
      <div class="card-body p-0">
        <div class="row">
          <div class="col-md-2 col-sm-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link" id="material-corporativo-tab" data-toggle="pill" href="#material-corporativo" role="tab" aria-controls="material-corporativo" aria-selected="false">Material Corporativo</a>
          ...
          <div class="col-md-10 col-sm-9" style="overflow-y: auto;">
            <div class="tab-content" id="v-pills-tabContent">
              <div class="tab-pane fade" id="material-corporativo" role="tabpanel" aria-labelledby="material-corporativo-tab">
                ...
                @endphp
                <strong><h2>Material Coporativo</h2></strong>
