  ...
  <div class="row ">
    <div class="col-md-4 col-sm-6 col-12">
      <a data-toggle="modal" data-target="#Permiso_Salida" style="cursor: pointer;">
        <div class="info-box bg-gradient-gray shadow">
    ...
    <div class="col-lg-6">
      <div class="card bg-seccion shadow">
        ...
        <div class="card-footer p-0">
          <img src="{{ asset('img/seccion_cumple.jpg') }}" class="img-fluid m-0 p-0 rounded-bottom">
        </div>
      </div>
      ...
      <div class="card bg-seccion shadow">
        ...
        <div class="card-footer p-0">
          <img src="{{ asset('img/trayectoria2.jpg') }}" class="img-fluid m-0 p-0 rounded-bottom">
        </div>
      </div>
