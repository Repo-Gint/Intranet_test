...
@endphp
  <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex align-items-stretch">
    ...
    <div class="card card-outline card-primary bg-directorio" style="background-color: rgba(255,255,255, 0.2);">
      ...
      <div class="card-body pt-0">
        <div class="row">
          ...
          <div class="col-4 text-center">
            <img src="http://10.0.0.8/Recursos_Humanos/images/Fotografias/{{ $empleado->Photo }}" alt="" class="img-circle img-fluid">
          </div>
        </div>
      </div>
