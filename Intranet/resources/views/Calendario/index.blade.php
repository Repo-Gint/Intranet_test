      ...
      <div class="card-body ">
        ...
        <div class="card bg-gradient-info ">
          <div class="card-body p-2">
            ...
            @if($mireservacion->Visit != null)
            <strong>Empresa:</strong> {{ $mireservacion->Visit }}<br>
            @endif
            @if($mireservacion->People != null)
            <strong>Personas:</strong> {{ $mireservacion->People }}<br>
            @endif
            @if($mireservacion->Parking != null)
            <strong>Estacionamiento:</strong> {{ $mireservacion->Parking }}<br>
            @endif
            </div>
          </div>
          ...
          <tr>
            <td>
              ...
              <div class="collapse" id="r{{ $reservacion->id }}">
                ...
                @if($reservacion->Visit != null)
                <strong>Empresa:</strong> {{ $reservacion->Visit }}<br>
                @endif
                @if($reservacion->People != null)
                <strong>Personas:</strong> {{ $reservacion->People }}<br>
                @endif
                @if($reservacion->Parking != null)
                <strong>Estacionamiento:</strong> {{ $reservacion->Parking }}<br>
                @endif
              </div>
            </td>
            <td>
      ...
      <div class="modal-body">
          ...
          <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              ...
              {!!  Form::time('Time_start', null, ['class' => 'form-control form-control-sm', 'autocomplete' => 'off','id' => 'time_s', 'required']) !!}
            </div>
            <div class="col-sm-4">
              {!!  Form::label('Fin', 'Fin: ', ['class' => 'col-form-label']) !!}
              {!!  Form::time('Time_end', null, ['class' => 'form-control form-control-sm', 'autocomplete' => 'off', 'id' => 'time_e', 'required']) !!}
            </div>
          </div>
          ...
          <div class="form-row mt-1">
            <div class="col-sm-6">
              {!! Form::label('Visita cliente o proveedor', 'Visita cliente o proveedor') !!}
            </div>
            <div class="col-sm-6">
              {!! Form::label('Si', 'Si') !!}
              {!! Form::radio('Visits', '1', false, array('id' => 'OpcionSi4')) !!}
              {!! Form::label('No', 'No') !!}
              {!! Form::radio('Visits', '0', false, array('id' => 'OpcionNo4')) !!}
            </div>
          </div>
          <div id="Datos_Adicionales4" style="display: none;">
            ...
            <div id="Datos_Adicionales2" style="display: none;">
              <div class="form-row mt-1">
                <div class="col-sm-6">
                  {!!  Form::label('Logo de empresa', 'Logo de empresa: ', ['class' => 'col-form-label']) !!}<br>
            ...
            <div class="form-row mt-1">
              <div class="col-sm-6">
                {!! Form::label('Requiere estacionamiento', '¿Requiere estacionamiento?') !!}
              </div>
              <div class="col-sm-6">
                {!! Form::label('Si', 'Si') !!}
                {!! Form::radio('Parking', '1', false, array('id' => 'OpcionSi3')) !!}
                {!! Form::label('No', 'No') !!}
                {!! Form::radio('Parking', '0', false, array('id' => 'OpcionNo3')) !!}
              </div>
            </div>
            <div id="Datos_Adicionales3" style="display: none;">
              <div class="form-row mt-1">
                <div class="col-sm-6">
                  {!! Form::label('Cuantos cajones', '¿Cuántos cajones?') !!}
                 {!!  Form::number('Estacionamiento', 0, ['class' => 'form-control form-control-sm', 'min'=> 0]) !!}<br>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  document.getElementById("time_s").min = "08:00";
  document.getElementById("time_s").max = "17:30";
  document.getElementById("time_e").min = "08:30";
  document.getElementById("time_e").max = "18:00";
   $(function () {
  ...
  $("#OpcionSi3").click(function(){
      $("#Datos_Adicionales3").show();

  });
  $("#OpcionNo3").click(function(){
      $("#Datos_Adicionales3").hide();

  });

  $("#OpcionSi4").click(function(){
      $("#Datos_Adicionales4").show();

  });
  $("#OpcionNo4").click(function(){
      $("#Datos_Adicionales4").hide();
