@extends('layouts.app')
@section('titulo', 'Módulos de Usuario / Gestor del Banner')
@section('content')
  ...
  <div class="col-lg-4 col-md-5">
    <div class="card">
      ...
      <div class="card-body" style="text-align: center;">
        ...
        <p>
          Resolución de imágenes: <strong>1920px x 500px</strong>
        </p>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            @foreach($imagenes as $imagen)
              <tr>
                <td>
                  <img src="{{ asset('img/Banner/'.$imagen->Name_file) }}" class="img-fluid">
                </td>
                <td style="text-align: center; vertical-align: middle;">
                  @can('Banner.destroy')
                   <a href="{{ route('Banner.destroy', $imagen->id) }}">
